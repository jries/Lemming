...
import org.lemming.processors.PeakPicker;
...
public class PeakPickerTest {
	...
	public void setUp() throws Exception {
		...
		peak = new PeakPicker(700);
		peak.setInput(frames);
		peak.setOutput(localizations);
		pipe.add(peak);
		
		
		File f = new File("/home/ronny/Bilder/resultsPeakPicker.csv");
