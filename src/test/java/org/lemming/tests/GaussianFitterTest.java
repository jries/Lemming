...
public class GaussianFitterTest {
	...
	public void setUp() throws Exception {
		...
		//AbstractModule fitter = new GaussianFitter<>(7, Settings.readCSV(System.getProperty("user.home")+"/ownCloud/storm/calTest.csv"));
		AbstractModule saver = new SaveLocalizationPrecision3D(new File(System.getProperty("user.home")+"/ownCloud/storm/test1.csv"));
