...
/**
 * The grabber is in charge to transfer data from matlab to Lemming.
 * 
...
public class MatlabGrabber<T> extends SO<T> {
    ...
    double[][] xloc; 								// Matlab arrays are always 2D
    double[][] yloc;
    double[][] frame;
    double[][] params;								// used to get parameters from matlab (for instance drifts)
