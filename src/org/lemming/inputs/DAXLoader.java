...
public class DAXLoader extends SO<Frame> {
	 ...
	 * @param daxFilename must be the full file path 
	 */
	 ...
	 * 
	 *  @param daxFilename - must be the full file path of the dax file
	 *  @param nFrames - the total number of frames
	 *  @param width - the image width (in pixels)  
	 *  @param height - the image height (in pixels)
	 *  @param bigEndian - whether the byte order is big-endian (as opposed to little-endian)  
