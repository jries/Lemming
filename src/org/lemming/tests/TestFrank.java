...
import org.lemming.inputs.RandomDouble;
import org.lemming.outputs.PrintToScreen;
import org.lemming.utils.LemMING;
import org.lemming.outputs.SendToCpp;
...
public class TestFrank {
	...
	public void test() {
		...
		QueueStore<Double> doubles = new QueueStore<Double>();
		RandomDouble rd = new RandomDouble(100,1,10);
		rd.setOutput(doubles);
		p.setInput(doubles);
