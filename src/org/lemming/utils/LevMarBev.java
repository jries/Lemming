 ...
 * @param double[] <b>x</b> (for 1D) or double[][] <b>xx</b> (for nD) - the x values
 * (the independent variable)</br></br>
 * @param double[] <b>y</b> - the y values (the dependent variable)</br></br>
 ...
 * @param double[] <b>dy</b> - the uncertainty for each value in {@code y}, used
 * as the weights (1/dy)^2</br></br>
 ...
 * (inclusive) using {@code nSteps} steps)</br></br>
 * @param double <b>xmin, xmax</b> (for 1D) or double[] <b>xxmin, xxmax</b> (for nD) -
 ...
 * was fixed in the fit then its uncertainty will be 0.0</li></br>
 * <li> double[][] <b>der</b> - a {@code p.length} by {@code y.length} array 
 * containing the values of the partial derivatives</li></br>
 * </ul>
 * 
 ...
 * function-evaluated values are calculated using the best-fit parameters</li></br>
 * <li> double[] <b>currentY</b> - the function evaluated at each x value using the 
 * latest best-fit parameters</li></br> 
...
public class LevMarBev implements Runnable {
	...
	int npts; // the length of the x and y arrays
	...
	double[] b; // holds temporary parameter values
	...
	// these variables are defined in the javadoc above
